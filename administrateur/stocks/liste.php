...
<body>
        ...
        ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div>
                    ...
                    }else if(isset($_GET['modifie']) && $_GET['modifie']=='no'){
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-bs-toggle="modal" data-bs-target="#editModal<?php echo $s['id']?>"
    ...
    <!-- Modal Modifier -->
    <div class="modal fade" id="editModal<?php  echo $stock['id'];?>" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Modifier Stock du
                        <span class="text-primary"><?php foreach($products as $index=>$p){
                                if($p['id'] == $stock['produit']){ 
                              echo $p['nom'];
                                    }
                                }
                                ?></span>
