...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                <a class="nav-link px-3" href="../../deconnect.php">Deconnection</a>
            </div>
        </div>
    </header>
        ...
        ?>
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <div>
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ajouter</a>
                    </div>
                    <!-- Liste start -->
                ...
                <div>
                    ...
                    if(isset($_GET['modifie']) && $_GET['modifie']=="erreur"){
                        print'<div class="alert alert-danger">
                        Produit n\'a pas modifié.
                        </div>';
                    }
                    ?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>'.$p['description'].'</td>
                                <td>'.$p['prix'].'</td>
                                <td> <img src= "../../images/'.$p['image'].'" style="width:5rem; height:5rem;"></td>
                                <td>'.$p['categorie'].'</td>
                                <td>
                                    <a   data-bs-toggle="modal" data-bs-target="#editModal'.$p['id'].'" class="btn btn-success" >Modifier</a>
                                    <a  onclick="return popUpDeleteproduit()" href="supprime.php?idc='.$p['id'].'" class="btn btn-danger">Supprimer</a>
                                </td>
                            </tr>                            
                                    ';
                                }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="ajout.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group   mb-2">
                            <input type="number" name="prix" class="form-control" placeholder="Prix de produit...">
                        </div>
                        <div class="form-group   mb-2">
    ...
    <!-- Modal Modifier -->
    <div class="modal fade" id="editModal<?php  echo $p['id'];?>" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="Modifie.php" method="post">
                        ...
                        <div class="form-group   mb-2">
                            <input type="text" name="nom" class="form-control" value="<?php   echo $p['nom']?>"
                        ...
                        <div class="form-group   mb-2">
                            <input type="number" name="prix" class="form-control" value="<?php   echo $p['prix']?>"
                                placeholder="Prix de Produit...">
                        </div>
                        <div class="input-group mb-3">
                            <a href="modifierphoto.php?id= <?php echo $p['id'] ?>">
                                <input type="button" class="form-control  btn btn-primary" name="image"
                                    value="Modifier photo">
                            </a>
                        </div>
                        <div class="form-group   mb-2">
                            <input type="number" name="categorie" class="form-control"
                                value="<?php   echo $p['categorie']?>" placeholder="Catégorie de Produit...">
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
